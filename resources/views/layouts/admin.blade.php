...
<html>
  <head>
    ...
    <title>Sistema de Gerenciamento de Material Bélico</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg">Matbel</span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="../../arma/arma"><i class="fa fa-circle-o"></i> Armas</a></li>
                <li><a href="../../arma/modelo"><i class="fa fa-circle-o"></i> Modelos</a></li>
                <li><a href="../../arma/tipo"><i class="fa fa-circle-o"></i> Tipos</a></li>
                <li><a href="../../arma/fabricante"><i class="fa fa-circle-o"></i> Fabricantes</a></li>
                <li><a href="../../arma/calibre"><i class="fa fa-circle-o"></i> Calibres</a></li>                
              </ul>
            </li>
            <li>
              <a href="http://127.0.0.1:8000/unidade">
                <i class="fa fa-info-circle"></i> <span>Cautelas</span>
              </a>
            </li>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Sistema de Gerenciamento de Material Bélico</h3>
