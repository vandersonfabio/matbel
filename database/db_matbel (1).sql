...
--
-- Host: 127.0.0.1
-- Generation Time: 16-Maio-2019 às 14:42
...
INSERT INTO `cautela` (`id`, `data`, `validade`, `qtdMunicao`, `qtdCarregador`, `observacao`, `isOpen`, `idArma`, `idRequerente`, `idSignatario`) VALUES
(1, '02/05/2019', NULL, 14, 2, NULL, 1, 1, 1, 4);
...
INSERT INTO `policial` (`id`, `nome`, `matricula`, `cpf`) VALUES
(1, 'Vanderson Fábio de Araújo', '123.456.7', '123.456.789-10'),
(2, 'Rodrigo Aggeu de Medeiros', '789.789-0', '789.789.789-00'),
(3, 'José Alexandre Lopes Pereira', '111.111-1', '111.111.111-11'),
(4, 'Walmary Costa', '000.000-0', '000.000.000-00');
...
CREATE TABLE `situacao` (
  `id` int(11) NOT NULL,
  `descricao` varchar(50) NOT NULL,
  `permiteCautela` tinyint(1) NOT NULL DEFAULT '1',
  `isActive` tinyint(1) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `situacao` (`id`, `descricao`, `permiteCautela`, `isActive`) VALUES
(4, 'Operacional', 1, 1),
(5, 'Em manutenção', 0, 1),
(6, 'À disposição da Justiça', 0, 1);
...
ALTER TABLE `cautela`
  ...
  ADD KEY `fk_cautela_signatario` (`idSignatario`);
...
ALTER TABLE `cautela`
  ...
  ADD CONSTRAINT `fk_cautela_signatario` FOREIGN KEY (`idSignatario`) REFERENCES `policial` (`id`) ON UPDATE CASCADE;
